var iOSScheme = (function(){
    ...
    iOSScheme.getReadScheme = function (bid, cid) {
        ...
        return "qqreader://com.tencent.reader?action=openBook&parameter=" + encodeURIComponent(JSON.stringify(o));
    };
    ...
    iOSScheme.getBookScheme = function (bid) {
        ...
        return "qqreader://com.tencent.reader?action=openDetail&parameter=" + encodeURIComponent(JSON.stringify(o));
    };
    ...
    iOSScheme.getUrlScheme = function (url) {
        ...
        return "qqreader://com.tencent.reader?action=openUrl&parameter=" + encodeURIComponent(JSON.stringify(o));
    };

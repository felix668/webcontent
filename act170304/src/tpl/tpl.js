...
var config = [{
  ...
  vendor: vendor.adr,
  bundle: 'main',
  dest: path.resolve( __dirname,'../../adr/main.html' ),
},{
  name: 'main',
  platform: 'ios',
  title: '阅读自由主义',
  ...
  vendor: vendor.ios,
  bundle: 'main',
  dest: path.resolve( __dirname,'../../ios/main.html' ),
},{
...
//   dest: path.resolve( __dirname,'../../ios/index.html' )
  ...
  vendor: vendor.ios,
  bundle: 'test',
  dest: path.resolve( __dirname,'../../ios/test.html' ),
  ...
  vendor: vendor.ios,
  bundle: 'guide',
  dest: path.resolve( __dirname,'../../ios/guide.html' ),
}]
...
<body>
  ...
  `<script type="text/javascript" src="../adr/dist/${a.bundle}.bundle.dev.js"></script>`}

...
if(window.pt=="adr"){
     var Local = (function( JsBridge,common){
        ...
        //QURL跳转,开启webview
        Local.gotoQUrl = function (url,fullscreen) {
           if(fullscreen == undefined){
              url="uniteqqreader://webpage/"+url;
            }else{
              url="uniteqqreader://webpage/fullscreen/"+url;
            }
        ...
        Local.openBookShelf=function(){
         ...
         Local.createBookList=function(maxBookLimit){
             JSBookList.createBookList(maxBookLimit);
         }
    ...
    var Local = (function(C,common){
        ...
        Local.createBookList=function(){
            C.callCocoa({
                "method": "createbooklist",
            });
        }
        //toast
        Local.showToast = function (msg) {
        ...
        //QURL跳转,开启webview fullscreen有值代表是沉浸式页面     
        Local.gotoQUrl = function (url,fullscreen) {
            if(fullscreen == undefined){
              url="uniteqqreader://webpage/"+url;
            }else{

...
var Local = (function( C,common ){
    ...
    Local.openMonth =function(count){
        C.callCocoa({
            "method": "paymonthvip",
            "month": count
        });
    ...
    Local.forceLog = function(act_f, act_b) {
        ...
        Local.reqaObj( server() + "sum?act_f=" + act_from + "&act_b=" + act_by,
            function(data) {
                ...
                // Local.showToast("网络不畅，请稍后再试试"+act_b);
            }, 1);
    }
    ...
    Local.$addToShelf = function(book,needtoast){
        ...
        C.callCocoa({
            ...
            "chapterTitle": book.chapterTitle || "第一章",
            "updatetime": book.updatetime || 0,
            "type": book.type || 0,
            "isPreview": book.isPreview || 0,
            "downloadinfo": Local.getdownload(book.downloadinfo),
            "needtoast": needtoast
        });
    };

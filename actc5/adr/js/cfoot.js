//【本函数库唯一需要手工配置的地方】
var _CONF = {
    LOCAL_HOST: 'http://solomotest4.3g.qq.com/book_res/event/act20151201/', //本地开发访问地址
    DEVELOP_SERVER: 'http://test3.wapmusic.qq.com/andmain/', 	//开发环境后台服务地址

    TEST_HOST: 'solomotest4.3g.qq.com',				//测试环境访问地址
    TEST_LOCAL_HOST: 'http://solomotest4.3g.qq.com/book_res/event/act20151201/', //测试环境访问地址
    TEST_SERVER: 'http://test3.wapmusic.qq.com/andmain/',	//测试环境后台服务地址
    TEST_ACCOUNTADDR: "http://solomotest4.3g.qq.com/book_res/reader/android/5_7/account.html",//测试环境我的账户页面地址

    FORMAL_HOST: 'iyuedu.qq.com',					//正式环境访问地址
    FORMAL_LOCAL_HOST: 'http://iyuedu.qq.com/event/act20151201/', //正式环境页面地址
    FORMAL_SERVER: 'http://event.book.qq.com/andmain/',		//正式环境后台服务地址
    FORMAL_ACCOUNTADDR: "http://iyuedu.qq.com/android/5_7/account.html"//正式环境我的账户页面
};

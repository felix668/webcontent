...
Login.midasURL = 'https://pay.qq.com/h5/index.shtml?m=buy&c=qqsubscribe&as=1&_newservice=1&service=TXWXIOSV56&appid=1450005390&pf=huyu_m-1000-iap-2011-yyios&sessionid=uin&sessiontype=skey';
...
Login.init=function(){
	...
	Login.cmap=cks();
    // TODO:test
    console.log("skey:"+ Login.cmap.skey);
};
...
Login.isLogin = function() {
    ...
    return false;
    // console.log("Login.isLogin:" + lsg("isLogin"));
    // console.log(nlg(lsg("isLogin"),'0'));
    // console.log(nlg(lsg("isLogin"),'0') == '1');
    // console.log("Login.isLogin:" + (lsg("isLogin"),'0')=='1');

...
Manager.prototype.init = function init () {
    var this$1 = this;
...
Manager.prototype.setDrawingWidth = function setDrawingWidth (val) {
...
Manager.prototype.on = function on (event, callback) {
...
Manager.prototype.callHooks = function callHooks (event) {
...
Manager.prototype.removeHook = function removeHook (arr, fn) {

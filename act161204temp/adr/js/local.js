        ...
        JSContent.getUsedSkinId(function (data) {
            ...
            switch(data){
                ...
                case '1016':
                    break;
                case '1013':
                    Local.includeLinkStyle("css/theme/woniu.css");break;
                case '1008':
                ...
                case '1014':
                    Local.includeLinkStyle("css/theme/huge.css");break;
                case '1010':
                    break;
                default:return ;
    }});
 ...
 * @param pagename
 */
Local.setWebTitlebarCheckIcon = function (isShow) {
    try {
        JSContent.setWebTitlebarCheckIcon(isShow);
    } catch (e) {
        console.log(e);
    }
};

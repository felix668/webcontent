...
// 【本函数库唯一需要手工配置的地方】
	var _CONF = {
		...
		TEST_SERVER : 'https://ptwapmusic3.reader.qq.com/iosmain/', // 测试环境后台服务地址
		TEST_SERVER_ROOT : 'https://ptwapmusic3.reader.qq.com/', // 测试环境后台服务地址

		FORMAL_HOST : 'yuedu.reader.qq.com', // 正式环境访问地址
		FORMAL_FRONT : 'https://ptsolomo.reader.qq.com/event/', // 测试环境前台地址
		FORMAL_SERVER : 'https://event.reader.qq.com/iosmain/', // 正式环境后台服务地址

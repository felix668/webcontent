//【本函数库唯一需要手工配置的地方】
var _CONF={
    LOCAL_HOST:		'http://solomotest4.3g.qq.com/book_res/bookevent/dec12/', //本地开发访问地址
    DEVELOP_SERVER:	'http://test3.wapmusic.qq.com/andmain/', 	//开发环境后台服务地址

	TEST_HOST:		'solomotest4.3g.qq.com',				//测试环境访问地址
	TEST_LOCAL_HOST:'http://solomotest4.3g.qq.com/book_res/bookevent/dec12/', //测试环境访问地址
	TEST_SERVER:	'http://test3.wapmusic.qq.com/andmain/',	//测试环境后台服务地址
	
	FORMAL_HOST:	'ireader.qq.com',					//正式环境访问地址
	FORMAL_LOCAL_HOST:'http://ireader.qq.com/bookevent/dec12/', //正式环境页面地址
...
//配置前台页面地址
var _HOST=_CONF.FORMAL_LOCAL_HOST; //开发环境
...
//	return _CONF.LOCAL_HOST;
	return _CONF.FORMAL_LOCAL_HOST;
//	return _HOST;
}
...
CommonShare = {};
CommonShare.SHARE_URL = host() + "index.html?sh_f=sq";
CommonShare.SHARE_PIC_URL = host() + "images/sharePic.jpg";
CommonShare.SHARE_TITLE = "大神喊你来偷书";
CommonShare.SHARE_DESC = "大神多，就是任性！和小伙伴们一起偷书，立抢iPhone6！";
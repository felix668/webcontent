		...
		methods: {
			...
			share: function share() {
				var shareObj = {
					...
					cover: "https://yuedu.reader.qq.com/event/act170101/com/images/cover.jpg",
					title: "风云榜颁奖盛典正在直播中！",
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-7ab6f4a0/MaskLoading.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"MaskLoading\" _v-7ab6f4a0=\"\">\n\t<p class=\"_text\" _v-7ab6f4a0=\"\"><img :src=\"'images/loading.png'\" _v-7ab6f4a0=\"\">正在加载...</p>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-9a494bc0/MaskOver.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"over\" _v-9a494bc0=\"\">\n\t<div class=\"over-c\" _v-9a494bc0=\"\">\n        <img :src=\"'images/over.png'\" alt=\"本期活动已结束\" _v-9a494bc0=\"\">\n        <p class=\"over-p1\" _v-9a494bc0=\"\">本期活动已结束</p>\n        <p class=\"over-p2\" _v-9a494bc0=\"\">敬请期待下一波活动</p>\n    </div>\n</div>\n";

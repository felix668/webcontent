...
var androidScheme = (function(){
    ...
    return {
        ...
        open: function (scheme, fail) {
            var clickedAt = +new Date;
            if (!fail) {
                fail = androidScheme.getandroidDownloadUrlV2('10002412');
            }
         ...
         * @returns {String}
         */
        getandroidUrlScheme: function (url) {
            var o = {
                "url": "" + url
            };
         ...
         * @returns {string}
         */
        getandroidDownloadUrlV2: function (android_downloadch) {
            return "http://misc.wcd.qq.com/app?packageName=com.qq.reader&channelId=" + (android_downloadch || this.android_downloadch);
        },

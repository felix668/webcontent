...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ && __vue_script__.__esModule && Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] act161202\\adr\\src\\_writers\\App.vue: named exports in *.vue files are ignored.");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeWriters = __webpack_require__(185);

	var _storeWriters2 = _interopRequireDefault(_storeWriters);
	...
	exports.default = {
		components: {
			...
			Ballot: __webpack_require__(187),
			Countdown: __webpack_require__(65),
		...
		data: function data() {
			return _storeWriters2.default.data;
		},
		computed: {},
		watch: {},
		...
		methods: {
			act: _storeWriters2.default.act
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _writers = __webpack_require__(186);

	var _writers2 = _interopRequireDefault(_writers);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var store = (0, _store.createStore)(_base2.default.data, _base2.default.act).merge(_writers2.default.data, _writers2.default.act);
						...
						if (!self.loggedIn) {
							...
							Local.reqaObj(common.server() + ('pkg161202/pick2?id=' + action.uid), function (data) {
								if (data.code === 1) {
									...
									Local.reqaObj(common.server() + 'pkg161202/getSQ2', function (data) {}, [], function () {
										Local.showToast("网络异常，请稍候重试");
									}, 1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ && __vue_script__.__esModule && Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] act161202\\adr\\src\\lib\\Ballot.vue: named exports in *.vue files are ignored.");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ && __vue_script__.__esModule && Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] act161202\\adr\\src\\lib\\Item.vue: named exports in *.vue files are ignored.");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = (_props$components$dat = {
		...
		computed: {},
		created: function created() {}
	}, (0, _defineProperty3.default)(_props$components$dat, 'watch', {}), (0, _defineProperty3.default)(_props$components$dat, 'methods', {
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"Item\" :style=\" 'background:url('+img+'/writers/'+info.uid+(info.uid===3?'_2':'')+'.png);background-size:100% auto;' \" @click=\"act({type:'TO_BOOK',bid:info.bid})\" _v-7b28acca=\"\">\n\t<p class=\"text_dbz\" _v-7b28acca=\"\">代表作</p>\n\t<p class=\"title\" _v-7b28acca=\"\">{{info.title}}</p>\n\t<div class=\"vote\" :class=\" (voted>=0&amp;&amp;voted===info.id?'voted':'')+' '+(voted>=0&amp;&amp;voted!==info.id?'disabled':'') \" @click=\"VOTE($event)\" _v-7b28acca=\"\">\n\t\t{{voted===info.id?'已投':'投票'}}\n\t</div>\n</div>\n";

/***/ },
/* 196 */
/***/ function(module, exports) {

	module.exports = "\n<div class=\"Ballot\" _v-94e9b4ca=\"\">\n\t<div class=\"row one\" _v-94e9b4ca=\"\">\n\t\t<item :info=\"items[0]\" :act=\"act\" :voted=\"voted\" :type=\"type\" :img=\"img\" :state=\"state\" _v-94e9b4ca=\"\"></item>\n\t\t<item :info=\"items[1]\" :act=\"act\" :voted=\"voted\" :type=\"type\" :img=\"img\" :state=\"state\" _v-94e9b4ca=\"\"></item>\n\t\t<item :info=\"items[2]\" :act=\"act\" :voted=\"voted\" :type=\"type\" :img=\"img\" :state=\"state\" _v-94e9b4ca=\"\"></item>\n\t</div>\n\t<div class=\"row two\" _v-94e9b4ca=\"\">\n\t\t<item :info=\"items[3]\" :act=\"act\" :voted=\"voted\" :type=\"type\" :img=\"img\" :state=\"state\" _v-94e9b4ca=\"\"></item>\n\t\t<item :info=\"items[4]\" :act=\"act\" :voted=\"voted\" :type=\"type\" :img=\"img\" :state=\"state\" _v-94e9b4ca=\"\"></item>\n\t\t<item :info=\"items[5]\" :act=\"act\" :voted=\"voted\" :type=\"type\" :img=\"img\" :state=\"state\" _v-94e9b4ca=\"\"></item>\n\t\t<item :info=\"items[6]\" :act=\"act\" :voted=\"voted\" :type=\"type\" :img=\"img\" :state=\"state\" _v-94e9b4ca=\"\"></item>\n\t</div>\n\t<div class=\"row three\" _v-94e9b4ca=\"\">\n\t\t<item :info=\"items[7]\" :act=\"act\" :voted=\"voted\" :type=\"type\" :img=\"img\" :state=\"state\" _v-94e9b4ca=\"\"></item>\n\t\t<item :info=\"items[8]\" :act=\"act\" :voted=\"voted\" :type=\"type\" :img=\"img\" :state=\"state\" _v-94e9b4ca=\"\"></item>\n\t\t<item :info=\"items[9]\" :act=\"act\" :voted=\"voted\" :type=\"type\" :img=\"img\" :state=\"state\" _v-94e9b4ca=\"\"></item>\n\t</div>\n</div>\n";

/***/ },
/* 197 */
/***/ function(module, exports) {

	module.exports = "\n\t<div id=\"root\" _v-0830c534=\"\">\n\t\t<mask-loading v-show=\" page==='pending' \" _v-0830c534=\"\"></mask-loading>\n\t\t<mask-over v-show=\" page==='over' \" _v-0830c534=\"\"></mask-over>\n\t\t\n\t\t<div class=\"main\" v-show=\" page==='ready' \" _v-0830c534=\"\">\n\t\t\t\n\t\t\t<mask-download v-show=\"show_mask_download\" :act=\"act\" _v-0830c534=\"\"></mask-download>\n\t\t\t<mask-prize v-show=\"show_mask_prize\" :act=\"act\" :img=\"img\" :ios=\"ios\" :prize=\"{id:1000}\" _v-0830c534=\"\"></mask-prize>\n\n\t\t\t<img class=\"header_writers\" :src=\" img+'/header_writers_2'+(ios?'_ios':'')+'.png' \" _v-0830c534=\"\">\n\n\t\t\t<img class=\"male_writer\" :src=\" img+'/male_writer.png' \" _v-0830c534=\"\">\n\n\t\t\t<ballot :type=\" 'male' \" :items=\"male\" :act=\"act\" :voted=\"male_voted\" :state=\"male_state\" :img=\"img\" _v-0830c534=\"\"></ballot>\n\n\t\t\t<img class=\"female_writer\" :src=\" img+'/female_writer.png' \" _v-0830c534=\"\">\n\n\t\t\t<ballot :type=\" 'female' \" :items=\"female\" :act=\"act\" :voted=\"female_voted\" :state=\"female_state\" :img=\"img\" _v-0830c534=\"\"></ballot>\n\n\t\t\t<div class=\"link\" @click=\"act({type:'TO_ACTORS'})\" _v-0830c534=\"\">\n\t\t\t\t<img :src=\" img+'/to_actors.png' \" _v-0830c534=\"\">\n\t\t\t</div>\n\n\t\t\t<rules :act=\"act\" :img=\"img\" _v-0830c534=\"\"></rules>\n\t\t\t\n\t\t\t<footer-fixed :male=\"male_voted\" :female=\"female_voted\" :timeleft=\"timeleft\" :act=\"act\" :img=\"img\" :share=\"share\" :chance=\"chance_to_draw\" _v-0830c534=\"\"></footer-fixed>\n\t\t</div>\n\n<!-- \t\t<debugger\n\t\t:state=\"$data\"></debugger> -->\n\t</div>\n";

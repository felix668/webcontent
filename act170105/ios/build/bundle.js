...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = new Vue({
	    ...
	    data: {
	        ...
	        rule: ['时间： 2017年1月28日10点 -  2月7日0点；', '充值赠送：单次(一次性)充值达到指定额度，则赠送对应额度阅券，多充多送！', '活动所赠阅券有效期均为15天并且即时到账，可用于直接购买书籍，起点账号用户首充礼包将于活动结束后发放；', '首充优惠活动仅限第一次充值用户参加，其余用户无法参加；', '本活动与苹果公司无关，最终解释权归QQ阅读所有。']
	    },
	    methods: {
	        initPage: function initPage() {
	            ...
	            //初始化init,获取数据
	            Local.reqaObj(server() + 'sum?act_b=index.html&act_f=' + (param('act_f') || -110), function (retdata) {
	                console.log(retdata);
	                self.showPage = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "/Users/luping/Desktop/work/code/activity/WebContent/act170105/ios/src/components/over.vue";
	...
	if (false) {
	  (function () {
	    ...
	    module.hot.accept();
	    if (!module.hot.data) {
	      hotAPI.createRecord("data-v-b8621edc", __vue_options__);
	    } else {
	      hotAPI.reload("data-v-b8621edc", __vue_options__);
	    }
	  })();
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-b8621edc!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./over.vue", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-b8621edc!./../../node_modules/sass-loader/index.js!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./over.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  module.hot.accept()
	  if (module.hot.data) {
	     require("vue-hot-reload-api").rerender("data-v-b8621edc", module.exports)
	  }
	}

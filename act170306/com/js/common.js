...
var _CONF = {
	...
	TEST_FRONT : 'http://solomotest4.3g.qq.com/book_res/event/', // 测试环境访问地址
//	TEST_SERVER : 'http://test3.wapmusic.qq.com/andmain/', // 测试环境后台服务地址
	...
	FORMAL_FRONT : 'http://iyuedu.qq.com/event/', // 正式环境访问地址
...
function front() {
	...
	}else if(window.location.hostname=="ptsolomo.reader.qq.com"){

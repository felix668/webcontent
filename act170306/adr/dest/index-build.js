	...
	exports.default = {
		...
		data: function data() {
			return {
				...
				draw: true,
				prizeNum: 0,
				prizename: ['精美手办', '钥匙扣', '100成长值', '50书券', '帽子'],
				prizeinfo: '',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-5c65d2c9/MaskLoading.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"MaskLoading\" _v-5c65d2c9=\"\">\n\t<p class=\"_text\" _v-5c65d2c9=\"\"><img :src=\"'images/loading.png'\" _v-5c65d2c9=\"\">正在加载...</p>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-73885497/MaskOver.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"over\" _v-73885497=\"\">\n\t<div class=\"over-c\" _v-73885497=\"\">\n        <img :src=\"'images/over.png'\" alt=\"本期活动已结束\" _v-73885497=\"\">\n        <p class=\"over-p1\" _v-73885497=\"\">本期活动已结束</p>\n        <p class=\"over-p2\" _v-73885497=\"\">敬请期待下一波活动</p>\n    </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-532ff842/MaskPrize.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);

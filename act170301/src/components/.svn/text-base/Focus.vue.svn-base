<template>
	<div class="Focus" ref="Focus">
		...
		<img class="logo" :src=" '../adr/img/logo.png' "/>

		<div class="content">
			<img class="bg_focus" :src=" 'img/bg_focus_2.png' "
			:class=" bg_focus "/>
			<div class="group"
			ref="group">
				<img class="man"
				...
				<img class="penguin" 
				ref="penguin"
				:src=" 'img/penguin_2.png' "/>
				<img class="shelf" :src=" 'img/shelf_2.png' "/>
			</div>
		</div>

		<img class="penguin_0" 
		ref="penguin_0"
		:class=" penguin_0 " :src=" 'img/penguin_0_2.png' "/>
		<img class="penguin_1"
		ref="penguin_1"
		:class=" penguin_1 " :src=" 'img/penguin_1_2.png' "/>
		
		<img class="title_0" :src=" 'img/title_0.png' "
		ref="title_0"/>
		<img class="title_1" :src=" 'img/title_1.png' "
		ref="title_1"/>

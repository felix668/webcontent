...
var config = [{
  ...
  vendor: vendor.adr,
  bundle: 'one',
  dest: path.resolve( __dirname,'../../adr/one.html' ),
},{
  batch: 'one',
  name: 'ques',
  platform: 'adr',
  ...
  vendor: vendor.adr,
  bundle: 'ques',
  dest: path.resolve( __dirname,'../../adr/ques.html' ),
},{
  batch: 'one',
  name: 'boiler',
  platform: 'adr',
  ...
  vendor: 
    `<script type="text/javascript" src="../adr/vendor/vue.min.js"></script>`,
  bundle: 'boiler',
  dest: path.resolve( __dirname,'../../adr/boiler.html' )
},{
  batch: 'two',
  name: 'two',
  platform: 'adr',
  ...
  vendor: vendor.adr,
  bundle: 'one',
  dest: path.resolve( __dirname,'../../adr/two.html' ),

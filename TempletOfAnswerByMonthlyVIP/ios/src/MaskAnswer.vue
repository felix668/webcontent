<template>
	<div class="answerpage">
			...
			<ul class="answerbox" :style="{color:ftcol}">
				<li v-for="index in 4"  :style="styleObj.cardStyle" class="card">
					<div class="padbox">
...
.ansewerlist li div{ display: block; position:absolute; left:0; top: 0; width: .3rem; height: .3rem; border-radius: 100%; border:1px solid;}

		...
		rules: [{
			...
			options: {
				loaders: {
		            ...
		            less: Ex.extract({fallback:'vue-style-loader',use:['css-loader','less-loader']}),
		            scss: Ex.extract({fallback:'vue-style-loader',use:['css-loader','sass-loader']}),
		            css: Ex.extract({fallback:'vue-style-loader',use:['css-loader']})
					// less: Ex.extract({

 ...
 * @param eventtype
 */
function reportPageEvent(eventname, eventtype, bid) {
    var ename = eventname;
    var etype = eventtype;
    ...
    try {
        ...
        var url = servercommon() + '/reportPageEvent?page=' + window.location.pathname + '&eventtype=' + etype + '&eventname=' + ename + "&ceventname=" + childname;
        if (param('pos')) {
            url += '&pos=' + param('pos');
        }
        if (param('adId')) {
...
function reportPageEventEx(callback, eventname, eventtype) {
    try {
        ...
        var url = servercommon() + '/reportPageEvent?page=' + window.location.pathname + '&eventtype=' + eventtype + '&eventname=' + eventname;
        if (param('pos')) {
            url += '&pos=' + param('pos');
        }
        if (param('adId')) {

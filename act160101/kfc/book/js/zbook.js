...
function reportPageEvent(eventname, eventtype) {
    try {
        ...
        Local.reqaObj(servercommon() + '/reportPageEvent?eventtype=' + eventtype + '&eventname=' + eventname, function (data) {
        }, [], function () {
        }, 1);
    } catch (e) {
    }
 ...
 * @param eventname
 */
ZBook.reportPageEvent = function(eventtype, eventname) {
    try {
        Local.reqaObj(servercommon() + '/reportPageEvent?eventtype=' + eventtype + '&eventname=' + eventname, function (data) {
        }, [], function () {
        }, 1);

	...
	exports.default = {
		...
		methods: {
			...
			goredbag: function goredbag() {
				Local.openPage("http://iyuedu.qq.com/event/act170106old/adr/index.html?act_f=170106");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-00a9618b/MaskLoading.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"MaskLoading\" _v-00a9618b=\"\">\n\t<p class=\"_text\" _v-00a9618b=\"\"><img :src=\"'images/loading.png'\" _v-00a9618b=\"\">正在加载...</p>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-6ce30d15/MaskOver.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"over\" _v-6ce30d15=\"\">\n\t<div class=\"over-c\" _v-6ce30d15=\"\">\n        <img :src=\"'images/over.png'\" alt=\"本期活动已结束\" _v-6ce30d15=\"\">\n        <p class=\"over-p1\" _v-6ce30d15=\"\">本期活动已结束</p>\n        <p class=\"over-p2\" _v-6ce30d15=\"\">敬请期待下一波活动</p>\n    </div>\n</div>\n";

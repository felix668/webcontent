var common = (function(){
	...
	var _CONF = {
		...
		TEST_SERVER : 'https://ptwapmusic3.reader.qq.com/'+(window.env?'activity':'iosmain')+'/', // 测试环境后台服务地址
		...
		FORMAL_SERVER : 'https://event.reader.qq.com/'+(window.env?'activity':'iosmain')+'/', // 正式环境后台服务地址

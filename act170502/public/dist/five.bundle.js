...
exports.default = {
	components: {
		...
		FixedFooterFive: __webpack_require__(70),
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "bbody",
    style: ('background-image:url(' + _vm.img + '/main/bg_five.png);background-size:100% auto;')
  }, [_c('div', {
    staticClass: "block"
  }, [_c('img', {
    staticClass: "cover",
    ...
    staticClass: "span1"
  }, [_vm._v(" 打包活动价" + _vm._s(_vm.price) + "元")])]), _c('fixed-footer-five')], 1)], 1)], 1)
},staticRenderFns: []}

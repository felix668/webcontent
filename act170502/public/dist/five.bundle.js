...
// console.log(Vix)
/* harmony default export */ __webpack_exports__["default"] = Vix;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Vix_js__ = __webpack_require__(1);
...
Vue.use(__WEBPACK_IMPORTED_MODULE_0__Vix_js__["default"]);

var store = __WEBPACK_IMPORTED_MODULE_0__Vix_js__["default"].createStore([__WEBPACK_IMPORTED_MODULE_1__base_js__["a" /* default */], __WEBPACK_IMPORTED_MODULE_2__main_js__["a" /* default */], __WEBPACK_IMPORTED_MODULE_3__test_js__["a" /* default */]]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', {
    ...
    staticClass: "no_"
  }, [_vm._v("1.")]), _vm._v("活动期间，可以按照优惠价格购买相应书籍在线阅读权，活动结束后，不再享有优惠。")]), _c('p', [_c('span', {
    staticClass: "no_"
  }, [_vm._v("2.")]), _vm._v("通过活动购买的书籍仅可以QQ阅读客户端内在线阅读，下载仍需付费。")]), _c('p', [_c('span', {
    staticClass: "no_"
...
var _Vix = __webpack_require__(1);
...
exports.default = {
	components: {
		...
		FixedFooterFive: __webpack_require__(74),
		MaskConfirm: __webpack_require__(37),
		MaskPrize: __webpack_require__(38),

		RulesPlain: __webpack_require__(54)
	},
	data: function data() {
		return {};
	},
	computed: _Vix2.default.computed({
		state: ['book_five', 'page', 'meta', 'img', 'priceOriginal', 'price']
	}),
	// {
	// 	book_five(){
	// 		return this.$store.state.book_five;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "bbody",
    style: ('background-image:url(' + _vm.img + '/main/bg_five_2.png);background-size:100% auto;')
  }, [_c('div', {
    staticClass: "block"
  }, [_c('div', {
    staticClass: "rounded"
    ...
    staticClass: "span1"
  }, [_vm._v(" 活动价" + _vm._s(_vm.price) + "元")])]), _c('img', {
    staticClass: "cover",
    attrs: {
      "src": _vm.book_five.cover
    },
    on: {
      "click": function($event) {
        _vm.$store.dispatch({
          type: 'TO_BOOK',
          bid: _vm.book_five.bid
        })
      }
    }
  }), _c('p', {
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.book_five.title))]), _c('p', {
    staticClass: "author"
  }, [_vm._v(_vm._s(_vm.book_five.author))]), _c('div', {
    staticClass: "intro"
  }, [_c('div', {
    staticClass: "cell"
  }, [_vm._v("\n\t\t\t\t\t\t\t" + _vm._s(_vm.book_five.intro) + "\n\t\t\t\t\t\t")])])])]), _c('rules-plain'), _c('fixed-footer-five')], 1), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.page === 'unloggedin'),
      expression: " page==='unloggedin' "
    }],
    staticClass: "main"
  }, [_c('div', {
    staticClass: "bar__"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v("\n\t\t\t\t" + _vm._s(_vm.deal.bought ? '去看书' : '我要抢购') + "\n\t\t\t\t"), _c('icon-arrows')], 1)])])
},staticRenderFns: []}

	...
	exports.default = {
		...
		methods: {
			initpage: function initpage() {
				...
				reqa(server() + "pkg170101/init", function (data) {
					console.log(data);
					self.loading = false;
					self.pagenum = data.code;
					self.over = data.isover;
					if (self.pagenum != 'A') {
						$(".lives").children('iframe').attr('src', '../com/video.html');
					}
				});
			...
			gotoapp: function gotoapp() {
				...
				S.open(function (installStat, plat) {
					if (installStat) {
						if (env.pt == "adr") {
							N.openPage("http://iyuedu.qq.com/event/act170101/adr/index.html");
						} else if (env.vw == "wx" && env.pt == "ios") {
							N.openPage("https://yuedu.reader.qq.com/event/act170101/ios/index.html");
							setTimeout(function () {
								self.downshow = true;
							}, 2000);
							setTimeout(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-71f79c14/MaskLoading.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"MaskLoading\" _v-71f79c14=\"\">\n\t<p class=\"_text\" _v-71f79c14=\"\"><img :src=\"'images/loading.png'\" _v-71f79c14=\"\">正在加载...</p>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-acb5f1a8/MaskOver.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"over\" _v-acb5f1a8=\"\">\n\t<div class=\"over-c\" _v-acb5f1a8=\"\">\n        <img :src=\"'images/over.png'\" alt=\"本期活动已结束\" _v-acb5f1a8=\"\">\n        <p class=\"over-p1\" _v-acb5f1a8=\"\">本期活动已结束</p>\n        <p class=\"over-p2\" _v-acb5f1a8=\"\">敬请期待下一波活动</p>\n    </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-84e08e40/MaskDownload.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"MaskDownload\" _v-84e08e40=\"\">\n\t<div class=\"mask-panel\" _v-84e08e40=\"\">\n\t\t<div class=\"top\" _v-84e08e40=\"\">下载QQ阅读，畅读海量小说</div>\n\t\t<p class=\"middle\" _v-84e08e40=\"\">如果还未安装QQ阅读，你可以：</p>\n\t\t<ul class=\"bottom\" _v-84e08e40=\"\">\n\t\t\t<li class=\"confirm\" @click=\"downapp\" _v-84e08e40=\"\">下载QQ阅读</li>\n\t\t\t<li class=\"cancel\" @click=\"closemask\" _v-84e08e40=\"\">取消</li>\n\t\t</ul>\n\t</div>\n</div>\n";

/***/ },
/* 20 */
/***/ function(module, exports) {

	module.exports = "\n<div id=\"root\">\n\t<div class=\"wrap\">\n\t\t<div class=\"bannerA\" v-if=\"pagenum=='A'\"></div>\n\t\t<div class=\"banner\" v-if=\"pagenum!='A'\"></div>\n\t\t<div class=\"timebox\">\n\t\t\t<div class=\"ttbox tt16\">\n\t\t\t\t<img :src=\"'images/tt16.png'\" />\n\t\t\t\t<div class=\"ttA\" v-show=\"pagenum=='A'\">\n\t\t\t\t\t<h4></h4>\n\t\t\t\t\t<p>1月10日敬请期待</p>\n\t\t\t\t</div>\n\t\t\t\t<!---->\n\t\t\t\t<div class=\"ttBC\" v-show=\"pagenum=='B' || pagenum=='C'\">\n\t\t\t\t\t<h4></h4>\n\t\t\t\t\t<p>精彩视频（建议在wifi下观看）</p>\n\t\t\t\t\t<div class=\"videbox\">\n\t\t\t\t\t\t\t<div class=\"videframe lives\">\n\t\t\t\t\t\t\t\t<iframe frameborder=\"0\" width=\"100%\" height=\"100%\" :src=\"\" allowfullscreen></iframe>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<!---->\n\t\t\t\t<div class=\"ttD\" v-show=\"pagenum=='D'\">\n\t\t\t\t\t<h4></h4>\n\t\t\t\t\t<p>精彩视频（建议在wifi下观看）</p>\n\t\t\t\t\t<div class=\"videbox\">\n\t\t\t\t\t\t\t<div class=\"videframe lives\">\n\t\t\t\t\t\t\t\t<iframe frameborder=\"0\" width=\"100%\" height=\"100%\" :src=\"\" allowfullscreen></iframe>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<!---->\n\t\t\t<div class=\"booklist\" v-show=\"pagenum=='C' || pagenum=='D'\">\n\t\t\t\t<div class=\"tt2\"></div>\n\t\t\t\t<p class=\"smalltt\">17年1月10号 19:00-1月11号 19:00限时免费读</p>\n\t\t\t\t<div class=\"childtt\">男生频道</div>\n\t\t\t\t<div class=\"bookbox swiper-container thumbs-cotnainer\">\n\t\t\t\t\t<ul class=\"swiper-wrapper\">\n\t\t\t\t\t\t<li class=\"swiper-slide\" v-for=\"book in booklist16man\" @click=\"gotoapp\">\n\t\t\t\t\t\t\t<img :src=\"book.cover\" />\n\t\t\t\t\t\t\t<p class=\"bookname\">{{ book.bname }}</p>\n\t\t\t\t\t\t\t<p>{{ book.authors }}</p>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"childtt\">女生频道</div>\n\t\t\t\t<div class=\"bookbox swiper-container thumbs-cotnainer\">\n\t\t\t\t\t<ul class=\"swiper-wrapper\">\n\t\t\t\t\t\t<li class=\"swiper-slide\" v-for=\"book in booklist16wom\" @click=\"gotoapp\">\n\t\t\t\t\t\t   <img :src=\"book.cover\" />\n\t\t\t\t\t\t   <p class=\"bookname\">{{ book.bname }}</p>\n\t\t\t\t\t\t   <p>{{ book.authors }}</p>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\t\n\t\t\t</div>\n\t\t\t<!---->\n\t\t\t<div class=\"ttbox tt15\">\n\t\t\t\t<img :src=\"'images/tt15.png'\" />\n\t\t\t\t<h4></h4>\n\t\t\t\t<p>精彩视频（建议在wifi下观看）</p>\n\t\t\t</div>\n\t\t\t<div class=\"videbox\">\n\t\t\t\t<div class=\"videframe\">\n\t\t\t\t\t<iframe frameborder=\"0\" width=\"100%\" height=\"100%\" :src=\"'https://v.qq.com/iframe/player.html?vid=v035374u8u4&tiny=0&auto=0'\" allowfullscreen></iframe>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<!---->\n\t\t\t<div class=\"booklist\">\n\t\t\t\t<div class=\"tt2\"></div>\n\t\t\t\t<div class=\"childtt\">男生频道</div>\n\t\t\t\t<div class=\"bookbox swiper-container thumbs-cotnainer\">\n\t\t\t\t\t<ul class=\"swiper-wrapper\">\n\t\t\t\t\t\t<li class=\"swiper-slide\" v-for=\"book in booklist15man\" @click=\"gotoapp\">\n\t\t\t\t\t\t\t<img :src=\"book.cover\" />\n\t\t\t\t\t\t\t<p class=\"bookname\">{{ book.bname }}</p>\n\t\t\t\t\t\t\t<p>{{ book.authors }}</p>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"childtt\">女生频道</div>\n\t\t\t\t<div class=\"bookbox swiper-container thumbs-cotnainer\">\n\t\t\t\t\t<ul class=\"swiper-wrapper\">\n\t\t\t\t\t\t<li class=\"swiper-slide\" v-for=\"book in booklist15wom\" @click=\"gotoapp\">\n\t\t\t\t\t\t   <img :src=\"book.cover\" />\n\t\t\t\t\t\t   <p class=\"bookname\">{{ book.bname }}</p>\n\t\t\t\t\t\t   <p>{{ book.authors }}</p>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\t\n\t\t\t</div>\n\t\t\t<!---->\n\t\t\t<div class=\"photobox\">\n\t\t\t\t<div class=\"tt2\"></div>\n\t\t\t\t<div class=\"photolist swiper-container pp-cotnainer\">\n\t\t\t\t\t<ul class=\"swiper-wrapper\">\n\t\t\t\t\t\t<li class=\"swiper-slide\" v-for=\"photo in photos\">\n\t\t\t\t\t\t\t<div class=\"ppbox\">\n\t\t\t\t\t\t\t\t<img :src=\"photo.imgurl\" />\n\t\t\t\t\t\t\t\t<p>{{ photo.tit }}</p>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class=\"btnbox\">\n\t\t\t<a href=\"javascript:\" @click=\"gotoapp\"></a>\n\t\t</div>\n\t</div>\n\t<mask-loading v-show=\"loading\"></mask-loading>\n\t<mask-over v-show=\"over\"></mask-over>\n\t<mask-download v-show=\"downshow\" :show.sync=\"downshow\"></mask-download>\n</div>\n";

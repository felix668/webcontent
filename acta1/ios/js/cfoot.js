...
var _CONF={
		...
		LOCAL_HOST_NAME: 'http://solomotest4.3g.qq.com/book_res/event/act4/', //本地开发访问地址
		...
		FORMAL_LOCAL_HOST:'http://iyuedu.qq.com/event/act4/', //正式环境页面地址
...
function getTransparentParam(){
	...
	str = seturlparam(str,"act_f");//统计使用
	return str;
}

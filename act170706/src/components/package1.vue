<template>
	<div class="plist" id="column1"> 
		...
		<div class="package" v-for="(item,index) in batchPackage" :style="`backgroundImage:url(${styleobj.columnbg1})`">
			<div class="pname">
				<h3>{{item.bagName}}</h3>
			</div>
			...
			<div class="buyinfo">
				...
				<div class="btn" v-if="!isbuy || isbuy.indexOf(index+'') == -1"  :style="{backgroundColor:styleobj.color2}" @click="buybook(index)">
					<strong>立即抢购</strong>

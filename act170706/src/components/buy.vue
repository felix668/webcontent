...
<script type="text/javascript">
	export default {
		props:["buyinfo","money","zmoney","btncolor","plat","pub"],
		data:function(){
			return{			
				fail:false,
		...
		methods:{
			...
			submit(){
				...
				this.canpick=false;
				let self=this;
				let server = this.buyinfo.clomn==1 ? "pkgTSJ/pick?pickId="+this.buyinfo.pickId+"&topicIds=329526,329536" : "pkgTSJ/choice?pickId="+this.buyinfo.pickId+"&choiceId="+this.buyinfo.choiceId+"&topicIds=329526,329536"
 				if (this.pub == 1) {
 					server = this.buyinfo.clomn==1 ? "pkgTSJ/pick?pickId="+this.buyinfo.pickId+"&topicIds=329564,329564" : "pkgTSJ/choice?pickId="+this.buyinfo.pickId+"&choiceId="+this.buyinfo.choiceId+"&topicIds=329564,329564"
 				}

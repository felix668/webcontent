...
Local.goNativeBookDetail = function (bid, origin, alg, datatype, fromBid, replaceorigin) {
    ...
    detailobj.bid = bid;
    detailobj.origin =711;
    detailobj.alg = alg;
    detailobj.datatype = datatype;
    detailobj.fromBid = fromBid;
    detailobj.stat_params = {};
    detailobj.stat_params.origin = 711;
    JSContent.openDetail(json(detailobj));
};
Local.readonline = function (bid,chapterid, chapterName) {
    var bookinfo ={};
    bookinfo.bid=bid;
    bookinfo.id=bid;
...
//跳转到native详情页
Local.openDetailByCode = function (pagecode) {
  //    dataObj的格式
  var obj = {};

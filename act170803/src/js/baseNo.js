...
var JsBridge =(function () {
    ...
    var l = navigator.userAgent,
        ...
        y = {publicAccount: ["getMemberCount", "getNetworkState", "getValue", "open",
        ...
        "getAppInfo", "getAppInfoBatch", "startSystemApp", "uninstallApp"]},
        u = {coupon: ["addCoupon", "addFavourBusiness", "gotoCoupon", "gotoCouponHome", "isCouponValid", "isFavourBusiness", "isFavourCoupon", "removeFavourBusiness"]},
        m = {}, n = {},
        x = function () {
        var b = 1;
        return function () {
...
if(window.pt=="adr"){
    var Local = (function( JsBridge,common){
        ...
        Local.resApis = function () {
            JsBridge.restoreApis({
                    ...
                    'JSAddToShelf': ['add', 'addBooks', 'addById','addComic'],
                    'JSToast': ['showToast'],
        ...
        Local.addComicToShelf = function(bookInfo, needToast) {
            ...
            // info.resType = 3; // 1 文本，2听书，3漫画
            JSAddToShelf.addComic(bookInfo, needToast);
        }
        //去书籍详情页
       ...
       //跳转充值页面
        ...
        //跳转到相应金额的充值页
        Local.doCharge = function (from,count) {
    ...
    var Local = (function(C,common){
        ...
        Local.addComicToShelf = function(bookInfo, needToast) {
            var info = obj(bookInfo);
            info.resType = 3; // 1 文本，2听书，3漫画
            Local.addToShelf(info, needToast);
        }
        //打开页面
        Local.openInside = function (url) {
            url += url.indexOf('?') != -1 ? '&' : '?';

...
/***/ function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) {
	  ...
	  console.warn("[vue-loader] adr/src/app.vue: named exports in *.vue files are ignored.");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		components: {
			maskLoading: __webpack_require__(11),
			maskOver: __webpack_require__(17),
			maskAnswer: __webpack_require__(21),
			maskResult: __webpack_require__(26)
		},
		data: function data() {
			return {
				loading: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) {
	  ...
	  console.warn("[vue-loader] adr/src/MaskLoading.vue: named exports in *.vue files are ignored.");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) {
	  ...
	  console.warn("[vue-loader] adr/src/MaskAnswer.vue: named exports in *.vue files are ignored.");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) {
	  ...
	  console.warn("[vue-loader] adr/src/MaskResult.vue: named exports in *.vue files are ignored.");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) {
	  ...
	  console.warn("[vue-loader] ios/src/app.vue: named exports in *.vue files are ignored.");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		components: {
			maskLoading: __webpack_require__(35),
			maskOver: __webpack_require__(40),
			maskAnswer: __webpack_require__(44),
			maskResult: __webpack_require__(49)
		},
		data: function data() {
			return {
				loading: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) {
	  ...
	  console.warn("[vue-loader] ios/src/MaskLoading.vue: named exports in *.vue files are ignored.");
	}
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-6ade9f09/MaskLoading.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"MaskLoading\" _v-6ade9f09=\"\">\n\t<p class=\"_text\" _v-6ade9f09=\"\"><img :src=\"'images/loading.png'\" _v-6ade9f09=\"\">正在加载...</p>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-a9461f52/MaskOver.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"over\" _v-a9461f52=\"\">\n\t<div class=\"over-c\" _v-a9461f52=\"\">\n        <img :src=\"'images/over.png'\" alt=\"本期活动已结束\" _v-a9461f52=\"\">\n        <p class=\"over-p1\" _v-a9461f52=\"\">本期活动已结束</p>\n        <p class=\"over-p2\" _v-a9461f52=\"\">敬请期待下一波活动</p>\n    </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) {
	  ...
	  console.warn("[vue-loader] ios/src/MaskAnswer.vue: named exports in *.vue files are ignored.");
	}
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-5e0c5f81/MaskAnswer.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-5e0c5f81&scoped=true!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./MaskAnswer.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-5e0c5f81&scoped=true!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./MaskAnswer.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.answerpage[_v-5e0c5f81]{ position: fixed; z-index: 111; left: 0; top: 0; width: 100%; height: 100%;}\n.answerbox[_v-5e0c5f81]{position: absolute; left: .3rem; top: .7rem; right: .3rem; bottom: 1rem; }\n.answerbox .card[_v-5e0c5f81]{ position: absolute; left: 0; bottom: 0; z-index: 10; width: 100%; height: 100%; box-shadow: 0 1px 18px rgba(47,26,41,.36);background-repeat:repeat-y; background-size:100% auto;border-radius: .1rem;-webkit-transform-origin:100% 0;}\n.answerbox .card.flyout[_v-5e0c5f81]{-webkit-animation:flyout 2s linear forwards;}\n@-webkit-keyframes flyout {\n  0%{ -webkit-transform:translate(0) rotate(0deg);}\n  10%{ -webkit-transform:translate(0) rotate(45deg);}\n  100%{-webkit-transform:translate(-1000px) rotate(45deg);}\n}\n@keyframes flyout {\n  0%{ -webkit-transform:translate(0) rotate(0deg);}\n  10%{ -webkit-transform:translate(0) rotate(45deg);}\n  100%{-webkit-transform:translate(-1000px) rotate(45deg);}\n}\n/**/.answerbox .card[_v-5e0c5f81]:nth-child(2){ z-index: 9; bottom: -.08rem;}\n.answerbox .card[_v-5e0c5f81]:nth-child(3){ z-index: 8; bottom: -.16rem;}\n.answerbox .card[_v-5e0c5f81]:nth-child(4){ z-index: 7; bottom: -.24rem;}\n.answerbox .card[_v-5e0c5f81]:nth-child(5){ z-index: 6; bottom: -.3rem;}\n.answerbox .card .padbox[_v-5e0c5f81]{padding: .4rem .28rem .4rem;}\n.answerbox .card h4[_v-5e0c5f81]{ position: relative; z-index: 1; font-size: .28rem; line-height: .48rem; height: .48rem; text-align: center;}\n.answerbox .card h4 span[_v-5e0c5f81]{position: absolute; display: block; right: 0.28rem; top: 0; height: .48rem; line-height: .48rem; font-size: .24rem;}\n.answerbox .card .answername[_v-5e0c5f81]{ font-size: .28rem; line-height: .48rem; margin:.1rem 0 .3rem;}\n.gobook p[_v-5e0c5f81],.nextanser p[_v-5e0c5f81]{ font-size: .2rem; text-align: center; line-height: .6rem;}\n.btn_gobook[_v-5e0c5f81]{ width: 5.98rem; height: .76rem; margin: 0 auto .8rem; line-height: .76rem; text-align: center; font-size: .36rem; background-repeat: no-repeat; background-size: 100% auto;}\n.title[_v-5e0c5f81]{ font-size: .28rem ;line-height: .6rem; font-weight: bold;}\n.ansewerlist li[_v-5e0c5f81]{position: relative; z-index: 1; padding-left: .6rem; line-height: .4rem; font-size: .28rem; margin: .24rem 0;/*display: -webkit-box;-webkit-line-clamp: 1;overflow: hidden;text-overflow: ellipsis;-webkit-box-orient: vertical;*/}\n.ansewerlist li div[_v-5e0c5f81]{ display: block; position:absolute; left:0; top: 0; width: .3rem; height: .3rem; border-radius: 100%; border:1px solid;}\n.nextanser[_v-5e0c5f81]{position:absolute; bottom: .4rem; left: 0; right: 0;}\n.btn_next[_v-5e0c5f81]{ width: 4.44rem; height: 1.04rem; margin: 0 auto; text-align: center; line-height: 1.04rem;background-repeat: no-repeat; background-size: 100% auto; font-size: .28rem;}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"answerpage\" _v-5e0c5f81=\"\">\n\t    <div class=\"hua\" _v-5e0c5f81=\"\"></div>\n\t\t<ul class=\"answerbox\" :style=\"{color:ftcol}\" _v-5e0c5f81=\"\">\n\t\t\t<li v-for=\"index in 4\" :style=\"styleObj.cardStyle\" class=\"card\" _v-5e0c5f81=\"\">\n\t\t\t\t<div class=\"padbox\" _v-5e0c5f81=\"\">\n\t\t\t\t\t<h4 _v-5e0c5f81=\"\"><span _v-5e0c5f81=\"\"><em :style=\"{color:redcol}\" _v-5e0c5f81=\"\">{{ index+1 }}</em>/{{ cardlist.list.length }}</span>{{ cardlist.card_tt }}</h4>\n\t\t\t\t\t<p class=\"answername\" _v-5e0c5f81=\"\">{{ list.answerName }}</p>\n\t\t\t\t\t<div class=\"gobook\" _v-5e0c5f81=\"\">\n\t\t\t\t\t\t<p :style=\"{color:redcol}\" _v-5e0c5f81=\"\">{{ tipnum[index] }}%的人在《{{ list.bookname }}》1-5章找到答案</p>\n\t\t\t\t\t\t<div class=\"btn_gobook\" :style=\"styleObj.btnstyle\" @touchstart.stop=\"touchStart($event)\" @touchend.stop=\"touchEnd(list.bid,$event)\" _v-5e0c5f81=\"\">书中找答案，再答题</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<p class=\"title\" _v-5e0c5f81=\"\">立即答题：</p>\n\t\t\t\t\t<ul class=\"ansewerlist\" _v-5e0c5f81=\"\">\n\t\t\t\t\t\t<li v-for=\"list in list.answerResult\" @click=\"selected($event)\" _v-5e0c5f81=\"\"><div :style=\"styleObj.radioStyle\" _v-5e0c5f81=\"\"></div>{{ list.answer }}</li>\n\t\t\t\t\t</ul>\n\t\t\t\t\t<div class=\"nextanser\" _v-5e0c5f81=\"\">\n\t\t\t\t\t\t<p :style=\"{color:redcol}\" _v-5e0c5f81=\"\">每道题只有1次答题机会，错过无奖励哦！</p>\n\t\t\t\t\t\t<div class=\"btn_next\" :style=\"styleObj.nextStyle\" @click=\"tonextAns($event)\" _v-5e0c5f81=\"\">{{ index!=(cardlist.list.length-1)?'下一题':'完成答题'}}</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t\n\t\t\t</li>\n\t   </ul>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (Object.keys(__vue_script__).some(function (key) {
	  ...
	  console.warn("[vue-loader] ios/src/MaskResult.vue: named exports in *.vue files are ignored.");
	}
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-02c6a060/MaskResult.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);

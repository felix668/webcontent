...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
		components: {
			...
			maskEject: __webpack_require__(24)
		},
		data: function data() {
			return {
				loading: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-9bf3946c/MaskLoading.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"MaskLoading\" _v-9bf3946c=\"\">\n\t<p class=\"_text\" _v-9bf3946c=\"\"><img :src=\"'../adr/public/images/loading.png'\" _v-9bf3946c=\"\">正在加载...</p>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-0e85b936/MaskOver.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"over\" _v-0e85b936=\"\">\n\t<div class=\"over-c\" _v-0e85b936=\"\">\n        <img :src=\"'../adr/public/images/over.png'\" alt=\"本期活动已结束\" _v-0e85b936=\"\">\n        <p class=\"over-p1\" _v-0e85b936=\"\">本期活动已结束</p>\n        <p class=\"over-p2\" _v-0e85b936=\"\">敬请期待下一波活动</p>\n    </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-cbb326c0/MaskAnswer.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-cbb326c0&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./MaskAnswer.vue", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/vue-loader/lib/style-rewriter.js?id=_v-cbb326c0&scoped=true!./../node_modules/vue-loader/lib/selector.js?type=style&index=0!./MaskAnswer.vue");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n.answerpage[_v-cbb326c0]{ position: fixed; z-index: 111; left: 0; top: 0; width: 100%; height: 100%;}\n.answerbox[_v-cbb326c0]{position: absolute; left: .3rem; top: .7rem; right: .3rem; bottom: 1rem; }\n.answerbox .card[_v-cbb326c0]{ position: absolute; left: 0; bottom: 0; z-index: 10; width: 100%; height: 100%; box-shadow: 0 1px 18px rgba(47,26,41,.36);background-repeat:repeat-y; background-size:100% auto;border-radius: .1rem;-webkit-transform-origin:100% 0;}\n.answerbox .card.flyout[_v-cbb326c0]{-webkit-animation:flyout 2s linear forwards;}\n@-webkit-keyframes flyout {\n  0%{ -webkit-transform:translate(0) rotate(0deg);}\n  10%{ -webkit-transform:translate(0) rotate(45deg);}\n  100%{-webkit-transform:translate(-1000px) rotate(45deg);}\n}\n@keyframes flyout {\n  0%{ -webkit-transform:translate(0) rotate(0deg);}\n  10%{ -webkit-transform:translate(0) rotate(45deg);}\n  100%{-webkit-transform:translate(-1000px) rotate(45deg);}\n}\n/**/.answerbox .card[_v-cbb326c0]:nth-child(2){ z-index: 9; bottom: -.08rem;}\n.answerbox .card[_v-cbb326c0]:nth-child(3){ z-index: 8; bottom: -.16rem;}\n.answerbox .card[_v-cbb326c0]:nth-child(4){ z-index: 7; bottom: -.24rem;}\n.answerbox .card[_v-cbb326c0]:nth-child(5){ z-index: 6; bottom: -.3rem;}\n.answerbox .card .padbox[_v-cbb326c0]{padding: .4rem .28rem .4rem;}\n.answerbox .card h4[_v-cbb326c0]{ position: relative; z-index: 1; font-size: .28rem; line-height: .48rem; height: .48rem; text-align: center;}\n.answerbox .card h4 span[_v-cbb326c0]{position: absolute; display: block; right: 0.28rem; top: 0; height: .48rem; line-height: .48rem; font-size: .24rem;}\n.answerbox .card h4 span em[_v-cbb326c0]{ color: #fd7258; }\n.answerbox .card .answername[_v-cbb326c0]{ font-size: .28rem; line-height: .48rem; margin:.1rem 0 .3rem;}\n.gobook p[_v-cbb326c0],.nextanser p[_v-cbb326c0]{ font-size: .2rem; text-align: center; line-height: .6rem;color: #fd7258;}\n.btn_gobook[_v-cbb326c0]{ width: 5.98rem; height: .76rem; margin: 0 auto .8rem; line-height: .76rem; text-align: center; font-size: .36rem; background-repeat: no-repeat; background-size: 100% auto;}\n.title[_v-cbb326c0]{ font-size: .28rem ;line-height: .6rem; font-weight: bold;}\n.ansewerlist li[_v-cbb326c0]{position: relative; z-index: 1; padding-left: .6rem; line-height: .4rem; font-size: .28rem; margin: .24rem 0;/*display: -webkit-box;-webkit-line-clamp: 1;overflow: hidden;text-overflow: ellipsis;-webkit-box-orient: vertical;*/}\n.ansewerlist li div[_v-cbb326c0]{ display: block; position:absolute; left:0; top: 0; width: .3rem; height: .3rem; border-radius: 100%; border:#6b4316 1px solid; }\n.nextanser[_v-cbb326c0]{position:absolute; bottom: .4rem; left: 0; right: 0;}\n.btn_next[_v-cbb326c0]{ width: 4.44rem; height: 1.04rem; margin: 0 auto; text-align: center; line-height: 1.04rem;background-repeat: no-repeat; background-size: 100% auto; font-size: .28rem;}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"answerpage\" _v-cbb326c0=\"\">\n\t    <div class=\"hua\" _v-cbb326c0=\"\"></div>\n\t\t<ul class=\"answerbox\" _v-cbb326c0=\"\">\n\t\t\t<li v-for=\"(item,index) in cardlist.list\" class=\"card\" _v-cbb326c0=\"\">\n\t\t\t\t<div class=\"padbox\" _v-cbb326c0=\"\">\n\t\t\t\t\t<h4 _v-cbb326c0=\"\"><span _v-cbb326c0=\"\"><em _v-cbb326c0=\"\">{{ index+1 }}</em>/{{ cardlist.list.length }}</span>每答对1道题，送{{ cardlist.quannum }}{{ urlis=='adr'?'书券':'阅券' }}</h4>\n\t\t\t\t\t<p class=\"answername\" _v-cbb326c0=\"\">{{ item.answerName }}</p>\n\t\t\t\t\t<div class=\"gobook\" _v-cbb326c0=\"\">\n\t\t\t\t\t\t<p _v-cbb326c0=\"\">{{ tipnum[index] }}%的人在《{{ item.bookname }}》1-5章找到答案</p>\n\t\t\t\t\t\t<div class=\"btn_gobook\" :style=\"styleObj.btnstyle\" @touchstart.stop=\"touchStart($event)\" @touchend.stop=\"touchEnd(item.bid,$event)\" _v-cbb326c0=\"\">书中找答案，再答题</div>\n\t\t\t\t\t</div>\n\t\t\t\t\t<p class=\"title\" _v-cbb326c0=\"\">立即答题：</p>\n\t\t\t\t\t<ul class=\"ansewerlist\" _v-cbb326c0=\"\">\n\t\t\t\t\t\t<li v-for=\"list in item.answerResult\" @click=\"selected($event)\" _v-cbb326c0=\"\"><div class=\"radio\" _v-cbb326c0=\"\"></div>{{ list }}</li>\n\t\t\t\t\t</ul>\n\t\t\t\t\t<div class=\"nextanser\" _v-cbb326c0=\"\">\n\t\t\t\t\t\t<p _v-cbb326c0=\"\">每道题只有1次答题机会，错过无奖励哦！</p>\n\t\t\t\t\t\t<div class=\"btn_next\" :style=\"styleObj.nextStyle\" @click=\"tonextAns($event)\" _v-cbb326c0=\"\">{{ index!=(cardlist.list.length-1)?'下一题':'完成答题'}}</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t\n\t\t\t</li>\n\t   </ul>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-3ee0ad7f/MaskResult.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-cdd392d2/ejectMask.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		props: ['mask', 'urlis'],
		methods: {
			gotodati: function gotodati() {
				var self = this;
				Local.reqaObj(server() + "pkgAnswerMonthlyVIP/init?tpc=" + param('tpc'), function (data) {
					console.log(data);
					self.$parent.isvip = data.isWhiteUser;
					self.$parent.config.card = data.card;
					self.$parent.userGd = data.gd;
				}, [], function () {}, 1);
				self.$parent.maskshow = false;
			}
		}
	};
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"mask\">\n\t<div class=\"tiparea\">\n\t\t<div class=\"gifticon\"></div>\n\t\t<div class=\"votes\">\n\t\t\t<p>陛下，若已开通包月，<br>就可以答题领{{ urlis=='adr'?'书券':'阅券'}}哟～～</p>\n\t\t\t<a class=\"closbtn\" @click=\"gotodati\"></a>\n\t\t</div>\n\t</div>\n</div>\n";

...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__js_set__ = __webpack_require__(2);
...
Component.options.__file = "/Users/zhaoran/Desktop/svn/运营活动/WebContent/act170710/src/app.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-641480e7", Component.options)
  } else {
    hotAPI.reload("data-v-641480e7", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__css_index__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_over__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_over___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_over__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	methods: {
		init: function init() {
			...
			if (false) {
				...
				Local.reqaObj(server, function (data) {
					...
					if (data.code == 0) {
						var weekExchangeInfo = data.weekExchangeInfo;
						_this.readpack = weekExchangeInfo;
						_this.readpack.icon = data.icon && !data.gsid ? data.icon : "src/images/default.png";
					}
					document.querySelector("#loadingbox").style.display = "none";
					_this.loading = false;
				}, [], function () {
		...
		pick: function pick() {
			...
			//领取阅读红包
			var data = { exchangedBilling: 10, code: 0 };
			Local.reqaObj(common.server() + "pkg170710/pick", function (data) {
				if (data.code == 0) {
					_this2.init();
					//跳转到下一页
	...
	components: {
		// maskLoad,
		maskOver: __WEBPACK_IMPORTED_MODULE_1__components_over___default.a
	},
	computed: {
...
Component.options.__file = "/Users/zhaoran/Desktop/svn/运营活动/WebContent/act170710/src/components/over.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3247d81a", Component.options)
  } else {
    hotAPI.reload("data-v-3247d81a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3247d81a", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [(!_vm.over && !_vm.loading) ? [_c('div', {
    staticClass: "userinfo"
  }, [_c('div', {
    staticClass: "avor"
  }, [_c('img', {
    attrs: {
      "src": _vm.readpack.icon
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "readinfo"
  }, [_c('p', [_vm._v("本周阅读时长：" + _vm._s(_vm.readpack.weekReadTime) + "分钟")]), _vm._v(" "), _c('div', {
    staticClass: "msg"
  }, [_vm._v(_vm._s(_vm.readpack.exchangedBilling == 0 ? (_vm.text1 + "可购买书籍，1" + _vm.text1 + "＝" + _vm.text2) : ("奖励已翻倍，已兑换" + (_vm.readpack.exchangedBilling) + _vm.text1)))])])]), _vm._v(" "), _c('div', {
    staticClass: "readpack"
  }, [_c('div', {
    staticClass: "rpbox"
  }, [_c('ul', {
    staticClass: "rplist",
    class: {
      'martop': _vm.readpack.critIndex < 4 && _vm.readpack.critIndex !== -1
    }
  }, _vm._l((_vm.readpack.exchangeDetailList), function(value, index) {
    return _c('li', {
      class: {
        'critli': value.isCrit, 'canchange': value.type == 1, 'changed': value.type == 0
      }
    }, [_c('div', {
      staticClass: "stepstyle"
    }, [_c('span', [_vm._v(_vm._s(!value.isCrit ? value.billing : value.type == 0 ? _vm.readpack.critNum * value.billing : "?"))])]), _vm._v(" "), _c('i', {
      staticClass: "steppoint"
    }), _vm._v(" "), (index > 0) ? _c('div', {
      staticClass: "line"
    }) : _vm._e(), _vm._v(" "), _c('time', [_vm._v(_vm._s(value.readTime) + "分钟")]), _vm._v(" "), (value.isCrit && value.type != 0) ? _c('p', {
      staticClass: "critmsg"
    }, [_vm._v("可获" + _vm._s(_vm.readpack.critRange) + "倍奖励")]) : _vm._e(), _vm._v(" "), (value.isCrit && value.type == 0) ? _c('p', {
      staticClass: "critmsg"
    }, [_vm._v("已获" + _vm._s(_vm.readpack.critNum) + "倍奖励")]) : _vm._e()])
  }))]), _vm._v(" "), (_vm.readpack.canExchangeBilling) ? _c('div', {
    staticClass: "getbtn",
    on: {
      "click": _vm.getRpack
    }
  }, [_vm._v("立即领取" + _vm._s(_vm.text1) + "和动漫抵扣券")]) : _vm._e(), _vm._v(" "), (!_vm.readpack.canExchangeBilling && !_vm.readpack.hasFinishExchange) ? _c('div', {
    staticClass: "getbtn grey"
  }, [_vm._v("还需阅读" + _vm._s(_vm.readpack.needReadTime) + "分钟领双倍奖励")]) : _vm._e(), _vm._v(" "), (_vm.readpack.hasFinishExchange) ? _c('div', {
    staticClass: "reached"
  }, [_vm._v("本周领取额度已满")]) : _vm._e()])] : _vm._e(), _vm._v(" "), (_vm.over) ? _c('mask-over') : _vm._e()], 2)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-641480e7", module.exports)
  }
}

<template>
	<div class="newbook cflex" :id="mdata.id" :mid="mdata.mid">	
		<img :src="mdata.btnpic0" @click="showmask" v-if="mdata.status === 1" class="btn">
		<img :src="mdata.btnpic1" v-else class="btn">	
...
.newbook{
	height: 1.6rem;
	.btn{/*width: 6.86rem;*/ height: .78rem}

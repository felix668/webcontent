	...
	exports.default = {
		...
		data: function data() {
			return {
				...
				listbook: [{
					id: '356106',
					cover: 'images/bookimg.png',
					title: '我真是大明星',
					author: '尝谕',
					profile: '一心想当明星的张烨穿越到了一个类似地球的新世界，酣畅淋漓的碾压之旅，从一次招聘会开始。'
				}],
				ticket: 2,
				ismengzhu: false,
				bookMonthCnt: 0,
		...
		methods: {
			initpage: function initpage() {
				var self = this;
				Local.init();
				Local.reqaObj(server() + "pkg161205/init", function (data) {
					console.log(data);
					self.loading = false;
					if (param("page") == 2) {
						self.ispageB = true;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-666597e5/MaskLoading.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"MaskLoading\" _v-666597e5=\"\">\n\t<p class=\"_text\" _v-666597e5=\"\"><img :src=\"'images/loading.png'\" _v-666597e5=\"\">正在加载...</p>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-dc2c301c/maskLogin.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-735804fb/MaskOver.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"over\" _v-735804fb=\"\">\n\t<div class=\"over-c\" _v-735804fb=\"\">\n        <img :src=\"'images/over.png'\" alt=\"本期活动已结束\" _v-735804fb=\"\">\n        <p class=\"over-p1\" _v-735804fb=\"\">本期活动已结束</p>\n        <p class=\"over-p2\" _v-735804fb=\"\">敬请期待下一波活动</p>\n    </div>\n</div>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-c09fb542/maskChat.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {
	  (function () {
	    ...
	    hotAPI.install(require("vue"), false);
	    if (!hotAPI.compatible) return;
	    var id = "_v-62e5391c/ejectMask.vue";
	    if (!module.hot.data) {
	      hotAPI.createRecord(id, module.exports);
	    } else {
	      hotAPI.update(id, module.exports, __vue_template__);

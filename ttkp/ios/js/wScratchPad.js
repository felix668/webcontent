...
(function($)
{
	...
	{
		width		: 257,						// set width - best to match image width
		height		: 60,				// set height - best to match image height
		image		: 'img/result3.png',		// set image path
		image2		: 'img/sbg.png',			// set overlay image path - if set color is not used

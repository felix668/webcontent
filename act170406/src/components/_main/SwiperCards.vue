...
<!-- 	<btn-share></btn-share>
	...
	ref="swiper">
		<ul class="train" 
			...
			<li class="item"
			v-if="carousel"
			:class=" currentOne===items.length-2?'active':'' ">
				<card-item :a="items[items.length-2]"></card-item>
			</li>
			<li class="item"
			v-if="carousel"
			:class=" currentOne===items.length-1?'active':'' ">
				<card-item :a="items[items.length-1]"></card-item>
			</li>
			...
			:class=" i===currentOne?'active':'' ">
				<card-item :a="a"></card-item>
			</li>

			<li class="item"
			v-if="carousel"
			:class=" currentOne===0?'active':'' ">
				<card-item :a="items[0]"></card-item>
			</li>
			<li class="item"
			v-if="carousel"
			:class=" currentOne===1?'active':'' ">
				<card-item :a="items[1]"></card-item>
			</li>
...
.Swiper__ {
	...
	.arrow_left {
		position: absolute; left: 0.3rem; top: 4.49rem;
		width: 0.33rem;
		z-index: 100;
	}
	.arrow_right {
		position: absolute; right: 0.3rem; top: 4.49rem;
		width: 0.33rem;
		z-index: 100;
	}

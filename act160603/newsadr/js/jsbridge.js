(function () {
    ...
    function g(b, c) {
        c = c || 1;
        if (j(h, c) < 0)console.info("version not match, apis ignored"); else for (var a in b) {
            var d =
                b[a];
    ...
    var l = navigator.userAgent, h = function (b) {
        return b && b[1] || 0;
    }(l.match(/V1_AND_SQ_([\d\.]+)/)), r = h && (j(h, "4.2.2") >= 0 || /_NZ\b/.test(l)), t = {publicAccount: ["close", "getJson", "getLocation", "hideLoading", "openInExternalBrowser", "showLoading", "viewAccount"]}, y = {publicAccount: ["getMemberCount", "getNetworkState", "getValue", "open",
        "openEmoji", "openUrl", "setRightButton", "setValue", "shareMessage", "showDialog"], qqZoneAppList: ["getCurrentVersion", "getSdPath", "getWebDisplay", "goUrl", "openMsgCenter", "showDialog", "setAllowCallBackEvent"], q_download: ["doDownloadAction", "getQueryDownloadAction", "registerDownloadCallBackListener", "cancelDownload", "cancelNotification", "doGCDownloadAction"], qzone_http: ["httpRequest"], qzone_imageCache: ["downloadImage", "getImageRootPath", "imageIsExist", "sdIsMounted", "updateImage", "clearImage"], qzone_app: ["getAllDownAppInfo",
        "getAppInfo", "getAppInfoBatch", "startSystemApp", "uninstallApp"]}, u = {coupon: ["addCoupon", "addFavourBusiness", "gotoCoupon", "gotoCouponHome", "isCouponValid", "isFavourBusiness", "isFavourCoupon", "removeFavourBusiness"]}, m = {}, n = {}, x = function () {
        var b = 1;
        return function () {
            return b++;
        };
    ...
    window.JsBridge = {callMethod: function (b, c) {
        q(b, c, [].slice.call(arguments, 2));
    }, callback: s, restoreApis: g, compareVersion: function (b) {
        return j(h, b);
    }};
})();